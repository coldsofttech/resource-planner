...
from apps.users.models import GroupProfile, UserProfile
from apps.users.tests.factories import make_group, make_profile, make_user

# ---------------------------------------------------------------------------
# UserProfile — auto-generated code
# ---------------------------------------------------------------------------
...
class UserProfileFieldDefaultsTest(TestCase):
    ...
    def test_updated_by_defaults_to_none(self):
        profile = make_profile()
        self.assertIsNone(profile.updated_by)
...
# ---------------------------------------------------------------------------
# UserProfile — explicit field assignments
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# UserProfile — relationship to User
# ---------------------------------------------------------------------------
...
class GroupProfileFieldDefaultsTest(TestCase):
    ...
    def test_created_by_defaults_to_none(self):
        gp = make_group_profile("Created By Group")
        self.assertIsNone(gp.created_by)

    def test_updated_by_defaults_to_none(self):
        gp = make_group_profile("Updated By Group")
        self.assertIsNone(gp.updated_by)
...
# ---------------------------------------------------------------------------
# GroupProfile — explicit field assignments
# ---------------------------------------------------------------------------
