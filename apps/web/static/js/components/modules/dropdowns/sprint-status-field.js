...
/* SprintStatusField: <sprint-status-field>
 *
 * Business-specific dropdown for the sprint status field.
...
class SprintStatusField extends DropdownField {
...
customElements.define("sprint-status-field", SprintStatusField);
